...
export function activate(context: vscode.ExtensionContext) {
	...
	console.log('Congratulations, your extension "jasmine-single-file-runner" is now active!');

	registerCommand('jsfr.helloWorld', () => {
		vscode.window.showInformationMessage('Hello World from Jasmine Single File Runner!');
	});

	registerTextEditorCommand('jsfr.testCurrentFile', () => {
		vscode.window.showInformationMessage(':DDDDDDD');
	});
}
